...
def cycle_download(books_id_list,books_name_list,save_path='./fanqie/'):
        # # id = '7384848950030781465'
        for i in range(len(books_id_list)):
                print(f'正在下载小说:{books_name_list[i]}...', end='')
                # print(books_id_list[i])
                download_book(books_id_list[i],save_path)
                print('')
                print(f'id为{books_name_list[i]}的小说下载完毕')


if __name__ == '__main__':
        # url地址(小说主页)
        latest_ranking_path = '最新榜路径'
        Hot_rankig_path = '最热榜路径'
        word_count_ranking_path = '字数榜路径'
        books_id_list, books_name_list = get_books_list_download.books_find(r'E:\python\test\demo01\20240624课设\py20240628\fanqie.csv')
        cycle_download(books_id_list,books_name_list)
